...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        left_side_panel = customtkinter.CTkFrame(self, width=150)
        left_side_panel.pack(side=tkinter.LEFT, fill=tkinter.Y, expand=False, padx=10, pady=10)
    
        # buttons to select the frames
        bt_frame1 = customtkinter.CTkButton(left_side_panel, text="Ship's Diary", command=self.frame1_selector,font=my_font)
        bt_frame1.grid(row=0, column=0, padx=20, pady=10)
        
        bt_frame2 = customtkinter.CTkButton(left_side_panel, text="Settings", command=self.frame2_selector,font=my_font)
        ...
        label = customtkinter.CTkLabel(App.frames['frame1'], text='Ship\'s Diary',font=('Roboto',26))
        ...
        switch_1 = customtkinter.CTkSwitch(App.frames['frame1'], text="pdf", command=switch_event1,font=my_font)
        switch_1.grid(row=0, column=1,padx=20, pady=10)

        switch_2 = customtkinter.CTkSwitch(App.frames['frame1'], text="docx", command=switch_event2,font=my_font)
        switch_2.grid(row=1, column=1,padx=20, pady=10)

        switch_3 = customtkinter.CTkSwitch(App.frames['frame1'], text="pptx", command=switch_event3,font=my_font)
        switch_3.grid(row=2, column=1,padx=20, pady=10)

        switch_4 = customtkinter.CTkSwitch(App.frames['frame1'], text="html", command=switch_event4,font=my_font)
        switch_4.grid(row=3, column=1,padx=20, pady=10)

        switch_5 = customtkinter.CTkSwitch(App.frames['frame1'], text="latex", command=switch_event5,font=my_font)
        ...
        ships = customtkinter.CTkLabel(App.frames['frame2'], text='Ship\'s Diary Settings',font=('Roboto',26))
